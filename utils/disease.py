disease_dic = {
    ...
    <img src="static\images\Apple\A1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Thiophanate Methyl</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        ...
        <br/>5. Be sure to remove the stumps of any apple trees you cut down. Dead stumps can be a source of spores.
            <br/> <div style="text-align: center;"><br/>
    <img src="static\images\Apple\A2.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Black ROT Be Gone ™ 60 ml</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        ...
        <br/>3. The best way to do this is to prune the branches about 4-6 inches below the galls.
            <br/> <div style="text-align: center;"><br/>
    <img src="static\images\Apple\A3.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">BLITOX FUNGICIDE</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=18#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        ...
        <br/>3. Follow cultural practices that promote good air circulation, such as pruning, and moderate shoot growth through judicious nitrogen management.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\cherry\c1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">EBS Bacillus Subtilis Bio Fungicide Powder</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=19#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        ...
        <br/>3. High risk factors for grey leaf spot in corn: <br/>
                    ...
                    h.	Favorable weather forecast for disease.
                      <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\corn\c1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Syngenta Amistar Fungicide (15 ML).</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=19#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Corn_(maize)___Common_rust_': """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        ...
        <br/>2. However, popcorn and sweet corn can be quite susceptible. In seasons where considerable rust is present on the lower leaves prior to silking and the weather is unseasonably cool and wet, an early fungicide application may be necessary for effective disease control. Numerous fungicides are available for rust control. 
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\corn\c2.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">SOFT Carbendazim 12% + Mancozeb 63% WP Fungicide</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=18#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        ...
        <br/>2. Scouting fields and monitoring local conditions is vital to control this disease.
            <br/> <div style="text-align: center;"><br/>
    <img src="static\images\corn\c3.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Bayer Antracol Fungicide 500 gm</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Grape___Black_rot': """ <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        ...
        <br/>3. Use protective fungicide sprays. Pesticides registered to protect the developing new growth include copper, captan, ferbam, mancozeb, maneb, triadimefon, and ziram. Important spraying times are as new shoots are 2 to 4 inches long, and again when they are 10 to 15 inches long, just before bloom, just after bloom, and when the fruit has set.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\grape\g1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Tebuconazole 10% + Sulphur 65% WG</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Grape___Esca_(Black_Measles)': """ <b>Crop</b>: Grape <br/>Disease: Black Measles<br/>
        ...
        <br/>3. The fungicides labeled as pruning-wound protectants, consider using alternative materials, such as a wound sealant with 5 percent boric acid in acrylic paint (Tech-Gro B-Lock), which is effective against Eutypa dieback and Esca, or an essential oil (Safecoat VitiSeal).
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\grape\g2.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Wound sealant with 5% boric acid in acrylic paint</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """ <b>Crop</b>: Grape <br/>Disease: Leaf Blight<br/>
        ...
        <br/>4. Spread a 3- to 6-inch layer of compost under trees, keeping it away from the trunk, to cover soil and prevent splash dispersal of the fungal spores.    
        <br/> <div style="text-align: center;"><br/>
    <img src="static\images\grape\g3.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Acibenzolar-S-methyl</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """<b> Crop</b> : Grape <br/> Disease: Leaf Spot
        <br/> <div style="text-align: center;"><br/>
    <img src="static\images\pepper\p1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Thiophanate Methyl</h2>
    <!-- Buy button -->
    ...
    'Orange___Haunglongbing_(Citrus_greening)': """ <b>Crop</b>: Orange <br/>Disease: Citrus Greening<br/>
        ...
        <br/>3. In addition to foliar nutritional sprays, plant growth regulators were tested, unsuccessfully, to reduce HLB-associated fruit drop (Albrigo and Stover, 2015).
         <br/> <div style="text-align: center;">   <br/>
    <img src="static\images\orange\o1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Citrus Huanglonbing</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=18#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Peach___Bacterial_spot': """ <b>Crop</b>: Peach <br/>Disease: Bacterial Spot<br/>
        ...
        <br/>4. Do not spray, tie, harvest, or handle wet plants as that can spread the disease.
            <br/> <div style="text-align: center;"><br/>
    <img src="static\images\peach\p1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">V Kure Bactericide & Fungicide</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=19#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
   ...
   <br/> <div style="text-align: center;"> <br/>
    ...
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">KRASUN K-101</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=19#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Potato___Early_blight': """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        ...
        <br/>4. Allow tubers to mature before digging, dig when vines are dry, not wet, and avoid excessive wounding of potatoes during harvesting and handling.
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\potato\p1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Bonide® Garden Dust</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=18#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Potato___Late_blight': """ <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
        ...
        <br/>3. If infection is found in only a few plants within a field, infected plants should be removed, disced-under, killed with herbicide or flame-killed to avoid spreading through the entire field.
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\potato\p2.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">BONIDE PRODUCTS 775 Ready-to-Use Copper Fungicide</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Squash___Powdery_mildew': """ <b>Crop</b>: Squash <br/>Disease: Powdery mildew<br/>
        ...
        <br/>4. If susceptible varieties are growing in an area where powdery mildew has resulted in yield loss in the past, fungicide may be necessary.
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\squash\s1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Bonide Tomato & Blossom Spray Set</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Strawberry___Leaf_scorch': """ <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        ...
        <br/>3. The avoidance of waterlogged soil and frequent garden cleanup will help to reduce the likelihood of spread of this fungus.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\strawberry\s1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">EBS Bacillus Subtilis Bio Fungicide</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Bacterial_spot': """ <b>Crop</b>: Tomato <br/>Disease: Bacterial Spot<br/>
        ...
        <br/>4. Do not spray, tie, harvest, or handle wet plants as that can spread the disease
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\Tomato\T1.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Dhanuka Zanet Thiophanate Methyl 44.8% + Kasugamycin 2.6% SC</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Early_blight': """ <b>Crop</b>: Tomato <br/>Disease: Early Blight<br/>
        ...
        <br/>6. Use drip irrigation instead of overhead irrigation to keep foliage dry.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\Tomato\T2.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Katyayani Azoxystrobin 11% + Tebuconazole 18.3% SC Systemic Fungicide</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=18#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Late_blight': """ <b>Crop</b>: Tomato <br/>Disease: Late Blight<br/>
        ...
        <br/> 3. The host range is typically limited to potato and tomato, but hairy nightshade (Solanum physalifolium) is a closely related weed that can readily become infected and may contribute to disease spread. Under ideal conditions, such as a greenhouse, petunia also may become infected.
            <br/> <div style="text-align: center;"><br/>
    <img src="static\images\Tomato\T3.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Valida Validamycine 3%L Fungicide</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=19#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Leaf_Mold': """ <b>Crop</b>: Tomato <br/>Disease: Leaf Mold<br/>
        ...
        <br/>7. Remove crop residue at the end of the season. Burn it or bury it away from tomato production areas.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\Tomato\T4.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Agriventure Tebcon ( Tebuconazole 25.9 % EC )</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=19#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Septoria_leaf_spot': """ <b>Crop</b>: Tomato <br/>Disease: Leaf Spot<br/>
        ...
        <br/>5. Use fungicidal sprayes.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\Tomato\T5.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Agrigib Gibberellic Acid 0.001% L</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=18#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """ <b>Crop</b>: Tomato <br/>Disease: Two-spotted spider mite<br/>
        ...
        <br/>3. Overhead irrigation or prolonged periods of rain can help reduce populations.
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\Tomato\T6.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Bifenazate (Acramite)</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Target_Spo': """ <b>Crop</b>: Tomato <br/>Disease: Target Spot<br/>
        ...
        <br/>4. Do not use overhead irrigation; otherwise, it will create conditions for spore production and infection.
           <br/> <div style="text-align: center;"> <br/>
    <img src="static\images\Tomato\T17.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;"> Elicitor acibenzolar-S-methyl</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """ <b>Crop</b>: Tomato <br/>Disease: Yellow Leaf Curl Virus<br/>
        ...
        <br/>3. Other methods to control the spread of TYLCV include planting resistant/tolerant lines, crop rotation, and breeding for resistance of TYLCV. As with many other plant viruses, one of the most promising methods to control TYLCV is the production of transgenic tomato plants resistant to TYLCV.
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\Tomato\T8.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">Bartelly F1</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=16#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>""",
    ...
    'Tomato___Tomato_mosaic_virus': """ <b>Crop</b>: Tomato <br/>Disease: Mosaic Virus<br/>
        ...
        <br/>4. Wash hands with soap and water before and during the handling of plants to reduce potential spread between plants.
          <br/> <div style="text-align: center;">  <br/>
    <img src="static\images\Tomato\T9.jpeg" alt="Thiophanate Methyl" style="margin-right: 20px;" width="350px" height="350px">
    <!-- Title -->
    <br>
    <h2 style="margin-top: 0; color:white;">BIO VIRICIDE FOR TOMATO & CUCURBIT PLANTS</h2>
    <!-- Buy button -->
    <br>
    <a href="http://localhost/FI/dishes.php?res_id=17#" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 10px 4px 2px;s cursor: pointer; border-radius: 8px;">Buy Now</a>
</div>"""
